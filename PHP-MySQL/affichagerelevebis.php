...
<?php
echo "</br>";
$req=$bdd->query("SELECT nom, dateheure, t, ff FROM releves INNER JOIN stations ON stations.idStation=releves.idStation WHERE nom='".$_POST['choixstation']."' AND dateheure=20190304".$_POST['heure']."0000 ORDER BY dateheure DESC;");
$f=0;
